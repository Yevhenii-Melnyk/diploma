...
public class TextCleaner {
	...
	private static List<String> nGram(List<String> words, int n) {
	...
	private static List<String> stemWords(String[] uniGrams) {
	...
	public static void main(String[] args) {
		System.out.println(Arrays.toString(cleanReview("This is really awesome imagination")));
	}
